...
class BenchmarkRepository:
    """
    Manages Benchmark resources (e.g. cluster_configs or workloads).
    """
    ...
    def _select_branch_version(self, distribution_version, pc_path):
        ...
        if distribution_version is not None:
            ...
            raise Exception("Distribution version is less than available ES versions for cluster-configs.")
