...
class NodeConfiguration:
    ...
    def as_dict(self):
        return {
            ...
            "cluster-config-runtime-jdks": self.cluster_config_runtime_jdks,
            "cluster-config-provides-bundled-jdk": self.cluster_config_provides_bundled_jdk,
            "ip": self.ip,
    ...
    def from_dict(d):
        return NodeConfiguration(
            d["build-type"], d["cluster-config-runtime-jdks"],
            d["cluster-config-provides-bundled-jdk"], d["ip"],
