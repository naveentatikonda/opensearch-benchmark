...
from osbenchmark.builder import cluster_config, supplier
...
class OpenSearchSourceSupplierTests(TestCase):
    def test_no_build(self):
        test_cluster_config = cluster_config.ClusterConfig("default", root_path=None, config_paths=[], variables={
    ...
    def test_raises_error_on_missing_cluster_config_variable(self):
        ...
        with self.assertRaisesRegex(exceptions.SystemSetupError,
                                    "ClusterConfig \"default\" requires config key \"system.build_command\""):
            opensearch.prepare()
...
class CreateSupplierTests(TestCase):
    ...
    def test_create_suppliers_for_os_only_config(self):
        ...
        test_cluster_config = cluster_config.ClusterConfig("default", root_path=None, config_paths=[])

        composite_supplier = supplier.create(cfg, sources=False, distribution=True, cluster_config=test_cluster_config)
    ...
    def test_create_suppliers_for_os_distribution_plugin_source_build(self):
        ...
        test_cluster_config = cluster_config.ClusterConfig(
        ...
        composite_supplier = supplier.create(
            ...
            cluster_config=test_cluster_config, plugins=[
            core_plugin,
            external_plugin
        ])
